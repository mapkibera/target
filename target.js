        ...
        $.each( data['features'], function( i, feature ) {
          ...
          $.each( target.validate , function (key, params) {
            ...
            $.each( params['validation'], function(j, validation_callback) {
              result = result && (target[ validation_callback ])( key, feature['properties']['tags'][key], params['options'], feature['properties']['tags'], Object.keys(target.validate) );
            });
            var result_class = (result ? "valid" : "invalid");

            //Filters
            var filtered_item = (feature['properties']['tags'][key] !== undefined ? feature['properties']['tags'][key] : "");
            if (params['filter'] !== undefined) {
              filtered_item = target[ params['filter'][0] ]( key, feature['properties']['tags'][key], feature['properties']['tags'], Object.keys(target.validate)  );
            }
